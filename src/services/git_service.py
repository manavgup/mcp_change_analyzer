...
from src.lib.models.git_models import (
    RepositoryAnalysis, FileChange, DirectorySummary, 
    LineChanges, FileStatusType, FileType, DiffSummary
)
...
class GitService:
        ...
        try:
            ...
            for line in status_output.splitlines():
                ...
                file_change = FileChange(
                    path=file_path,
                    staged_status=FileStatusType(staged_status if staged_status != " " else FileStatusType.NONE),
                    unstaged_status=FileStatusType(unstaged_status if unstaged_status != " " else FileStatusType.NONE),
    ...
    async def analyze_repository(self, 
        ...
        try:
            ...
            logger.info(f"Repository analysis complete. Files: {total_files_changed}, Lines: {total_lines_changed}")
            return analysis
        except Exception as e:
    ...
    def _generate_directory_summaries(self, file_changes: List[FileChange]) -> List[DirectorySummary]:
        """
        ...
        for directory, files in directory_map.items():
            ...
            summary = DirectorySummary(
                ...
                files=[file_change.path for file_change in files],
